setwd("C:/Users/yucheng/Dropbox/Prospective MNC")
load("SMNC_permu_MultiT5_typeI_halfQ.rda")
load("SMNC_permu_MultiT5_typeI_doubleQ.rda")
load("SMNC_permu_MultiT5_typeI_cen30.rda")
load("SMNC_permu_MultiT5_typeI_cen10.rda")
load("SMNC_permu_MultiT5_adjusted.rda")
load("SMNC_permu_MultiT5_power_halfQ.rda")
load("SMNC_permu_MultiT5_power_doubleQ.rda")
load("SMNC_permu_MultiT5_power_cen30.rda")
load("SMNC_permu_MultiT5_power_cen10.rda")
load("SMNC_permu_MultiT5_power.rda")
...
pdf("diff_vists_v2.pdf", par(mfrow=c(1,2)), paper='USr')
#par(mfrow=c(1,2))
...
plot(r1~seq(0.001,0.1,by=0.0001),ylim=c(0,max(r1,r2,r3,r4,r5)), col='gray0' ,cex.main=1.5, cex.lab=1.3,type='l',xlab='alpha',ylab='Power',lwd=2,main='Under Alternative')
